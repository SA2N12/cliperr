...
- Ancre chaque idée dans du CONCRET et RECONNAISSABLE : privilégie des sujets CÉLÈBRES et VÉRIFIABLES que le spectateur peut reconnaître ou googler (ex. le manuscrit de Voynich, le signal Wow!, les lignes de Nazca, le mécanisme d'Anticythère, une étude ou un personnage connus…) + un artefact précis (enregistrement, lettre, document, objet, étude, match…) et une date ou un chiffre EXACT dans le titre. ⛔ ÉVITE ABSOLUMENT les sujets obscurs ou qui « sonnent inventés » (ils ne déclenchent ni recherche, ni commentaire, ni crédibilité → ils plafonnent) et les concepts purement abstraits (ils sous-performent nettement). Un sujet reconnaissable = crédibilité + envie de commenter/vérifier.
- Les DEUX dernières étapes du script doivent déclencher l'ENGAGEMENT : (a) une question directe ou une affirmation clivante adressée au spectateur (→ COMMENTAIRES : « Coïncidence ou pas ? Ton avis en commentaire »), ET (b) une raison de PARTAGER (« Envoie ça à quelqu'un qui refuse de croire à… », « Taggue celui qui… ») — le PARTAGE est le signal le plus puissant pour l'algorithme, priorise-le.

⚠️ SÉCURITÉ — RÈGLES DE LA COMMUNAUTÉ TIKTOK (priorité ABSOLUE : un seul manquement fait RETIRER la vidéo et pénalise la portée de TOUT le compte pendant des semaines) :
- Traite tout sujet sensible de façon FACTUELLE, sobre et respectueuse. INTERDIT : le sensationnalisme morbide, les détails graphiques (violence, blessures, mort, sang, corps), les reconstitutions ou photos de victimes réelles, les images choquantes ou traumatisantes.
- ÉVITE : les crimes violents réels (meurtres, tueurs en série, agressions, enlèvements) avec victimes réelles identifiables, les suicides et l'automutilation, les catastrophes avec de nombreux morts traitées de façon sensationnaliste, les actes dangereux imitables, les accusations visant des personnes réelles.
- N'affirme JAMAIS une rumeur ou une hypothèse comme un FAIT : présente clairement l'inexpliqué COMME non résolu (« on ne sait toujours pas… », « selon une hypothèse… »). Aucune désinformation, aucune théorie complotiste présentée comme vérité.
- Fais FRISSONNER par le MYSTÈRE et l'AMBIANCE, jamais par l'horreur graphique : phénomènes inexpliqués (signaux, lieux, objets), énigmes historiques et scientifiques, curiosités naturelles, artefacts mystérieux, codes non déchiffrés, disparitions anciennes évoquées avec pudeur. L'intrigue sans victime ni gore performe AUSSI bien et ne se fait pas supprimer.
        ...
        ...(reproduce
          ? {
              dialogue: {
                type: 'boolean',
                description:
                  "VRAI si la source fait parler PLUSIEURS personnages qui s'échangent des répliques (saynète, sketch, conversation), FAUX si c'est une seule voix off / un seul narrateur qui parle. Base-toi sur la transcription : plusieurs interlocuteurs distincts = vrai."
              }
            }
          : {})
      },
      required: reproduce
        ? ['title', 'hook', 'angle', 'script', 'format', 'hashtags', 'imageStyle', 'dialogue']
        : ['title', 'hook', 'angle', 'script', 'format', 'hashtags', 'imageStyle']
    }
  } satisfies Anthropic.Tool
